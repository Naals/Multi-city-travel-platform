...
public class RabbitMQConfig {
    ...
    public static final String BOOKING_RESULTS_EXCHANGE = "travel.booking.results";
    ...
    public static final String BOOKING_COMPLETED_QUEUE  = "booking.payment.completed";
    public static final String BOOKING_FAILED_QUEUE     = "booking.payment.failed";
    ...
    public static final String RK_BOOKING_COMPLETED = "booking.payment.completed";
    public static final String RK_BOOKING_FAILED    = "booking.payment.failed";
    ...
    @Bean
    public DirectExchange bookingResultsExchange() {
        return ExchangeBuilder.directExchange(BOOKING_RESULTS_EXCHANGE).durable(true).build();
    }
    ...
    public Queue bookingFailedQueue() {
        return QueueBuilder.durable(BOOKING_FAILED_QUEUE).build();
    }
    ...
    public Binding bookingCompletedBinding() {
        return BindingBuilder.bind(bookingCompletedQueue())
                .to(bookingResultsExchange()).with(RK_BOOKING_COMPLETED);
    }

    @Bean
    public Binding bookingFailedBinding() {
        return BindingBuilder.bind(bookingFailedQueue())
                .to(bookingResultsExchange()).with(RK_BOOKING_FAILED);
    }
